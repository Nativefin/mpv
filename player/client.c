...
#if IS_LG_WEBOS
void mpv_starfish_bridge_begin_session(const char* app_id, const char* window_id, int platform_id) {
    starfish_bridge_begin_session(app_id, window_id, platform_id);
}
